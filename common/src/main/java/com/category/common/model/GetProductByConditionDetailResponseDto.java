...
@Setter
@NoArgsConstructor
public class GetProductByConditionDetailResponseDto {
    @JsonProperty("카테고리")
    ...
    private Long id;
    @Builder
    public GetProductByConditionDetailResponseDto(CategoryType categoryType, String brandName, BigDecimal price, Long id) {
